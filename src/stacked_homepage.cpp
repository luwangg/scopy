...
{
	s_hc = new HomepageControlls(this);
	this->installEventFilter(s_hc);
	connect(s_hc, &HomepageControlls::goLeft, this, &StackedHomepage::moveLeft);
	connect(s_hc, &HomepageControlls::goRight, this, &StackedHomepage::moveRight);
	connect(s_hc, &HomepageControlls::openFile, this, &StackedHomepage::openFile);
